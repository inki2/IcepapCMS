...
class Ui_OscillaWindow(object):
    def setupUi(self, OscillaWindow):
        ...
        self.labelClear = QtGui.QLabel(self.centralwidget)
        self.labelClear.setMaximumSize(QtCore.QSize(60, 16777215))
        self.labelClear.setObjectName(_fromUtf8("labelClear"))
        self.hloClearButtons.addWidget(self.labelClear)
        ...
        self.btnClearSignal.setMaximumSize(QtCore.QSize(82, 16777215))
        ...
        self.btnClearAll.setMaximumSize(QtCore.QSize(46, 16777215))
